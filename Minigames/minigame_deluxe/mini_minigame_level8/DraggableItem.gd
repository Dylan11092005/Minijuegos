...
# =========================================================
# CONFIGURACIÓN (la asigna EruptionMain al armar el nivel)
# =========================================================
...
# EruptionMain sobreescribe este valor por objeto para ajustar la
# tolerancia exacta que necesite cada uno; esto es solo un respaldo.
var snap_radius: float = 110.0
